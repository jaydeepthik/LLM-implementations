...
if __name__ =="__main__":
    np.random.seed(0)
    inputs = np.random.randn(5, 8)
    np.random.seed(0)
    c_attn = {"w":np.random.randn(8, 3*8), "b":np.random.randn(1, 3*8)}
    np.random.seed(0)
    c_proj = {"w":np.random.randn(8, 8), "b":np.random.randn(1, 8)}
    n_head = 1
    ...
    np.random.seed(0)
    inputs_nokv = np.random.randn(5, 8)
    np.random.seed(0)
    c_attn = {"w":np.random.randn(8, 3*8), "b":np.random.randn(1, 3*8)}
    np.random.seed(0)
    c_proj = {"w":np.random.randn(8, 8), "b":np.random.randn(1, 8)}
